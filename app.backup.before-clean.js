...
db.serialize(() => {
    ...
    const defaultChambers = [
        { name: '温箱A', description: '标准温箱，温度范围-40℃~85℃', temperature_range: '-40℃~85℃', capacity: '100L' },
        ...
        { name: '温箱D', description: '快速温变箱，温度范围-60℃~120℃', temperature_range: '-60℃~120℃', capacity: '200L' },
        { name: '温箱E', description: '小型温箱，温度范围-20℃~85℃', temperature_range: '-20℃~85℃', capacity: '50L' },
        { name: '温箱F', description: '防爆温箱，温度范围-40℃~80℃', temperature_range: '-40℃~80℃', capacity: '120L' },
        { name: '温箱G', description: '真空温箱，温度范围-60℃~100℃', temperature_range: '-60℃~100℃', capacity: '180L' },
...
app.get('/admin/change-password', requireAdmin, (req, res) => {
    ...
    res.render('admin/change-password', { title: '修改管理员密码', user: req.session.username, role: req.session.userRole, message, error });
});
...
async function sendReservationNotification(userId, chamberId, reservationData) {
    try {
        ...
        const mailOptions = {
            ...
            subject: '温箱预约申请已提交 - 温箱预约系统',
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600